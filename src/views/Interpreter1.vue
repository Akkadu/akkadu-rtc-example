<template>
  <div style="display:flex; align-items: center; flex-direction: column;">
    <h1 style="text-align: center;">
      Akkadu Receiver test page
    </h1>
    <h2
      id="stream-state"
      style="text-align: center; color:white; border-radius: 2px; width:200px;"
    >
      Stream stopped
    </h2>
    <button
      id="toggle"
      style="color:white; margin:5px; height: 100px; width: 200px; box-shadow: 5px 5px darkslategrey; border-radius: 10px; background-color: #1a72ff"
    >
      Toggle Stream!
    </button>
  </div>
...
onMounted(async () => {
    ...
    streamer.on('connection-status', (msg) => {
      ...
      switch (id) {
        ...
        case 'connection-online':
          ...
          toast.info('Akkadu Connection online!')
          akkaduOnline = true
          break
      }
    })
  ...
  console.log({ akkaduOnline, akkaduActive })
